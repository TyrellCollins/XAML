...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        registerArduinoCommand("arduino.showBoardManager", () => {
            return vscode.commands.executeCommand("vscode.previewHtml", constants_1.BOARD_MANAGER_URI, vscode.ViewColumn.Two, "Arduino Board Manager");
        });
        registerArduinoCommand("arduino.showLibraryManager", () => {
            return vscode.commands.executeCommand("vscode.previewHtml", constants_1.LIBRARY_MANAGER_URI, vscode.ViewColumn.Two, "Arduino Library Manager");
        });
        ...
        registerArduinoCommand("arduino.showExamples", (forceRefresh = false) => {
